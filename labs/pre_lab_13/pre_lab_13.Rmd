...
**Task** Run the following code. Describe the model output. What do you see? **Answer: we see that the p-value is very high which indicates no statistical significance along with a slightly negative correlation.**
