...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** While I feel like this is a really cool tool to gauge vocabulary usage in politics, I also think that the sentiments attached to the words might not always be correct. I think context in this case is very important and can get lost when technology is used to categorize the words.
