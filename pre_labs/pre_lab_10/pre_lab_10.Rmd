...
The output is a map of Maryland with counties. It takes the amount of foreclosures in a given zipcode as a value and fills the shape of each county with a color indicative of the number of foreclosures in March.
