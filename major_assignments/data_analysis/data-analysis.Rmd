...
**Answer:** We looked at the percentage of Democratic and Republican MD votes for the presidential and senate votes. We found that 64.3 percent of Democratic voters participated in the presidential election, while 55.6 percent Republicans voted in the presidential election. On the Senate, it was 55.6 percent for Democrat and 44.4 percent for the Republican.

```{r}
#Question 2: How many registered voters compared to voter turnout by state? 
...
**Answer:** 5,3469.25 was the average number of registered voters that turned out by county. 
...
**Answer:** Counties where there was a democratic win had a higher turnout than counties where there was a republican win.
...
senate_county_turnout <- senate_by_county|>
  mutate(total= angela_alsobrooks_democratic + larry_hogan_republican + mike_scott_libertarian + patrick_j_burke_write_in_other_candidates + billy_bridges_write_in_unaffiliated + irwin_william_gibbs_write_in_unaffiliated + christy_renee_helmondollar_write_in_unaffiliated + robin_rowe_write_in_unaffiliated)|>
...
**Answer:** Montgomery county had the highest turnout in the election with 48,504 voters total out of a total of 2,921,595.
